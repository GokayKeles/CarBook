...
namespace CarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("GetCarCountByKmLessThen10000")]
        public async Task<IActionResult> GetCarCountByKmLessThen10000()
        {
            var values = await _mediator.Send(new GetCarCountByKmLessThen10000Query());
            return Ok(values);
        }
